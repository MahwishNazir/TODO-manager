...
2. Select framework (React/HTML/Vue)
3. Follow framework-specific guide

## Framework guides

- React: See [REACT.md](references/REACT.md)
- HTML: See [HTML.md](references/HTML.md)
- Vue: See [VUE.md](references/VUE.md)
```

Only the chosen framework's guide loads into context.
